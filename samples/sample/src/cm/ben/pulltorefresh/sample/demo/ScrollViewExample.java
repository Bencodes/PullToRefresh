...
public class ScrollViewExample extends BaseActivity implements PullToRefreshView.OnPullToRefreshListener {
	...
	public void onCreate (Bundle savedInstanceState) {
		...
		super.setContentView(R.layout.content_scroll_view);
